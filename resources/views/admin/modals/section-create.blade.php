<div class="absolute inset-0 min-h-screen">
	...
	<div class="absolute inset-0 z-10">
		...
		<div class="mx-auto p-4 my-16 bg-white w-1/3 shadow-lg rounded-lg">
			<div class="text-lg text-teal-600">
				<fi icon="plus"></fi>
				<span class="ml-1 font-semibold">Create new Section</span>
			</div>
			...
			<form action="">
				...
				<div class="flex justify-end items-center mt-8 mb-4">
					...
					<button class="ml-2 px-4 py-1 pb-2 rounded-lg font-semibold bg-teal-600 text-gray-100 hover:bg-teal-700">Create new section</button>
				</div>
